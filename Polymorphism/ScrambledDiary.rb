...
scramble = ScrambledDiary.new("amina")
puts scramble.scramble_by_advancing_chars(1)
puts scramble.unscramble_by_advancing_chars(1)
puts scramble.scramble_by_reversing
puts scramble.unscramble_by_reversing
